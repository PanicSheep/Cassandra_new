...
{
public:
	AlphaBetaFailHardSearch(const AlphaBetaFailHardSearch&) = default;
	AlphaBetaFailHardSearch(const std::shared_ptr<Engine>& env) : Search(env) {}
...
private:
	...
	int Eval_1(const CPosition&, int alpha, int beta, CMove move1);
