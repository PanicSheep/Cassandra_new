...
namespace std
{
	inline iStreamArchive& getline(iStreamArchive& stream, std::string& string)
	{
...
class iostreamArchive : public StreamArchive
{
	...
	std::ostream& ostream;
public:
	iostreamArchive(std::istream& istream, std::ostream& ostream) : istream(istream), ostream(ostream) {}
