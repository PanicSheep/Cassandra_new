...
./bin/weightfitter -p e3_1M e4_1M e5_1M e6_1M e7_1M -m matvec/rnd -v matvec/rnd -w matvec/range1
./bin/weightfitter -p e6_1M e7_1M e8_1M e9_1M e10_1M -m matvec/rnd -v matvec/rnd -w matvec/range2
...
do
	...
	./bin/weightfitter -p e$((3*e+0))_1M e$((3*e+1))_1M e$((3*e+2))_1M e$((3*e+3))_1M e$((3*e+4))_1M -m matvec/rnd -v matvec/rnd -w matvec/range${e}
done
